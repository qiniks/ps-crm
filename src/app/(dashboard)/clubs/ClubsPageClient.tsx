...
// The single-club case is handled server-side, before this component ever
// mounts (see page.tsx) — this effect only remains as a fallback for the
// count dropping to 1 *during* this session (e.g. archiving every other
// club), which page.tsx's one-time check can't catch.
